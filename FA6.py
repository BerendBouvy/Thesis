...
def reconstruction_loss(test_loader, FA_model, VAE_model):
    ...
    test_data_tensory = test_loader.dataset.dataset.y[test_loader.dataset.indices]
    ...
    # VAE_recon_mse = 0
    with torch.no_grad():
        VAE_output = VAE_model.forward(test_data_tensor, test_data_tensory, compute_loss=True)
