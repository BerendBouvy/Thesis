...
def main(n_sets, n_samples, high_dim, latent_dim, epsilon_snr, std_A, non_linear_ratio, cross_ratio, 
    ...
    #             latent_dim=20, epsilon_snr=epsilon_snr, std_A=std_A, non_linear_ratio=non_linear_ratio, 
...
if __name__ == "__main__":
    ...
    num_epochs = 100
    density = 1
    beta = 0 #np.linspace(0, 1e-2, num_epochs)
    batch_size = 256
    verbose = False
    n_iter = 5000
    tol = 1e-3
    ...
    # num_epochs = 300
    # density = 1
    # beta = np.linspace(0, 1e-2, num_epochs)
    # batch_size = 64
    # verbose = False
    # n_iter = 5000
    # tol = 1e-3
